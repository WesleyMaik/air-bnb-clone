...
import { HTMLAttributes, useState, MutableRefObject, useRef } from "react";
...
const Category = () => {
    ...
    sliderRef = useRef() as React.MutableRefObject<Slider>,
    categories = [
        {
            name:"Ilha",
            imgName:"island.jpeg"
    ...
    const handleArrow = () => console.log(sliderRef.current)
